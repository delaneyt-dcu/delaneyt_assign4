...
public class MatchFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        //if (savedInstanceState != null) {
         //   counterA = savedInstanceState.getInt("Team_A");
         //   counterB = savedInstanceState.getInt("Team_B", 0);
         //          noOfPenA = savedInstanceState.getInt("Pen_A");
         //           noOfPenB = savedInstanceState.getInt("Pen_B", 0);
         //          noOfConA = savedInstanceState.getInt("Con_A");
         //           noOfConB = savedInstanceState.getInt("Con_B", 0);
         //           noOfTryA = savedInstanceState.getInt("Try_A", 0);
         //           noOfTryB = savedInstanceState.getInt("Try_B", 0);
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putInt("Team_A", counterA);
        outState.putInt("Team_B", counterB);
        outState.putInt("Pen_A", noOfPenA);
        outState.putInt("Pen_B", noOfPenB);
        outState.putInt("Con_A", noOfConA);
        outState.putInt("Con_B", noOfConB);
        outState.putInt("Try_A", noOfTryA);
        outState.putInt("Try_B", noOfTryB);
